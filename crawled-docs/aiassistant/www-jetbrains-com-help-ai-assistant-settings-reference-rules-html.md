...
New Project Rules File

Click to create the `.aiassistant/rules` folder in the project root and add a `.md` file there.

For additional information, refer to [Configure project rules](configure-project-rules.html).
