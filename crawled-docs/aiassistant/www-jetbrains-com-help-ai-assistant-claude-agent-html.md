...
![Select Claude Agent](https://resources.jetbrains.com/help/img/idea/2026.2/ai_switch_chat_mode_intro.png "Select Claude Agent")
...
Each language model has a context window – the maximum amount of information it can process at once. As you exchange messages with Claude Agent, your prompts, attached context, and the agent's responses fill this window. Once it becomes full, the agent may lose track of earlier parts of the session.
...
![Select operation mode](https://resources.jetbrains.com/help/img/idea/2026.2/ai_claude_agent_operation_modes.png "Select operation mode")

The following modes are available:

-   Auto – let the model decide whether to approve or deny the permission prompts.

-   Manual – standard behavior; prompts for sensitive operations.
...
![Select the model](https://resources.jetbrains.com/help/img/idea/2026.2/ai_chat_claude_agent_model_selection.png "Select the model")
...
![Fast mode toggle](https://resources.jetbrains.com/help/img/idea/2026.2/ai_claude_agent_fast_mode.png "Fast mode toggle")
...
![Claude Agent requests an approval](https://resources.jetbrains.com/help/img/idea/2026.2/ai_claude_code_approve_request.png "Claude Agent requests an approval")

-   Allow once – allows Claude Agent to perform the action this time only. You will be asked again if the same action is requested later.

-   Always allow – allows Claude Agent to perform this action automatically, without asking for permission.

-   Deny – prevents Claude Agent from performing this action.
...
-   For a suggested file change, click ![the Show Diff button](https://resources.jetbrains.com/help/img/idea/2026.2/app-client.expui.vcs.diff.svg "the Show Diff button") to review the changes the agent introduces.
    ...
    ![Open the diff to review the file changes Claude Agent suggests before you approve them](https://resources.jetbrains.com/help/img/idea/2026.2/ai_claude_agent_review_suggested_changes.png "Open the diff to review the file changes Claude Agent suggests before you approve them")
...
![Run MCP command](https://resources.jetbrains.com/help/img/idea/2026.2/ai_chat_claude_agent_run_mcp_command.png "Run MCP command")
...
In DataGrip, Claude Agent requires the Pass IntelliJ MCP Server setting to be enabled to use database-specific tools:

1.  In the IDE settings (CtrlAlt0S), go to Tools | AI Assistant | Agents.

2.  Make sure that Pass IntelliJ MCP server is set to On.

3.  Click OK.

[![The Pass IntelliJ MCP Server setting](https://resources.jetbrains.com/help/img/idea/2026.2/db_settings_pass_intellij_mcp_server.png "The Pass IntelliJ MCP Server setting")](https://resources.jetbrains.com/help/img/idea/2026.2/db_settings_pass_intellij_mcp_server.png)
...
![List of / commands](https://resources.jetbrains.com/help/img/idea/2026.2/ai_claude_agent_commands.png "List of / commands")
