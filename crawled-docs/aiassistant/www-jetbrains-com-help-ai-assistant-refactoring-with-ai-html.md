...
2.  In the menu, click Suggest Refactoring.
    ...
    ![Suggest Refactoring](https://resources.jetbrains.com/help/img/idea/2026.1/ai_popup_find_problems.png "Suggest Refactoring")

    The AI chat will open to offer you refactoring suggestions.

    [![AI Assistant: AI Assistant suggests refactoring](https://resources.jetbrains.com/help/img/idea/2026.1/ai_suggest_refactoring.png "AI Assistant: AI Assistant suggests refactoring")](https://resources.jetbrains.com/help/img/idea/2026.1/ai_suggest_refactoring.png)
...
4.  In the editor, review the changes by clicking ! Next Change and ! Previous Change buttons.
    ...
    [![Diff tab with refactored code](https://resources.jetbrains.com/help/img/idea/2026.1/ai_refactoring_diff.png "Diff tab with refactored code")](https://resources.jetbrains.com/help/img/idea/2026.1/ai_refactoring_diff.png)
...
![AI Assistant suggests new names](https://resources.jetbrains.com/help/img/idea/2026.1/ai_suggest_renaming.png "AI Assistant suggests new names")
...
2.  Use the Provide AI-generated name suggestions checkbox.
    ...
    ![Enable name suggestion option in AI Assistant settings](https://resources.jetbrains.com/help/img/idea/2026.1/name_suggestions.png "Enable name suggestion option in AI Assistant settings")
...
1.  Right-click a function or method definition to open the context menu.
    ...
    Alternatively, place the caret on it and press ⌥ Option↩Enter.

2.  Select AI Actions and then Add Type Hints.

    ![Adding Python type annotations via AI Assistant](https://resources.jetbrains.com/help/img/idea/2026.1/py_ai_type_annotations_select.png "Adding Python type annotations via AI Assistant")

3.  Type annotations are added to the function definition.

    ![Python type annotations added via AI Assistant](https://resources.jetbrains.com/help/img/idea/2026.1/py_ai_type_annotations_result.png "Python type annotations added via AI Assistant")
