...
![Web preview in JetBrains Air](https://resources.jetbrains.com/help/img/air/aird_web_preview_in_air.png "Web preview in JetBrains Air")
...
-   Click the web or code mode icon in the upper-right corner of the Preview tool.
    ...
    ![Switching between preview and source code modes](https://resources.jetbrains.com/help/img/air/aird_switching_between_web_and_code_modes.png "Switching between preview and source code modes")
